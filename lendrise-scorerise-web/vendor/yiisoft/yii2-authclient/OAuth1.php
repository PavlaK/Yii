...
class OAuth1 extends BaseOAuth
{
    ...
    public function fetchRequestToken(array $params = [])
    {
        ...
        $response = $this->sendSignedRequest($this->requestTokenMethod, $this->requestTokenUrl,
    ...
    public function fetchAccessToken(OAuthToken $requestToken = null, $oauthVerifier = null, array $params = [])
    {
        ...
        $response = $this->sendSignedRequest($this->accessTokenMethod, $this->accessTokenUrl,
            array_merge($defaultParams, $params));
    ...
    protected function composeSignatureBaseString($method, $url, array $params)
    {
        ...
        uksort($params,
            'strcmp'); // Parameters are sorted by name, using lexicographical byte value ordering. Ref: Spec: 9.1.1
        $parts = [
            strtoupper($method),
            $url,
