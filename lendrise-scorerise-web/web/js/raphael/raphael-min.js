...
!function (a) {
    ...
    function s(a, d, e, f, g, h) {
        ...
        if (f)for (v = 0, x = gb.length; x > v; v++) {
            var u = gb[v];
    ...
    var u, v, w = /[, ]+/, x = {
        ...
        hs: 1,
        rg: 1
    }, ga = /,?([achlmqrstvxz]),?/gi, ha = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, ia = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, ja = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi, ka = (c._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/, {}), la = function (a, b) {
        return _(a) - _(b)
    }, ma = function (a) {
        return a
        ...
        if (!b)return a;
        var c, d, e, f, g, h, i;
        for (a = Ja(a), e = 0, g = a.length; g > e; e++)for (i = a[e], f = 1, h = i.length; h > f; f += 2)c = b.x(i[f], i[f + 1]), d = b.y(i[f], i[f + 1]), i[f] = c, i[f + 1] = d;
        return a
    };
    ...
    c.color = function (a) {
        var b;
        return c.is(a, "object") && "h"in a && "s"in a && "b"in a ? (b = c.hsb2rgb(a), a.r = b.r, a.g = b.g, a.b = b.b, a.hex = b.hex) : c.is(a, "object") && "h"in a && "s"in a && "l"in a ? (b = c.hsl2rgb(a), a.r = b.r, a.g = b.g, a.b = b.b, a.hex = b.hex) : (c.is(a, "string") && (a = c.getRGB(a)), c.is(a, "object") && "r"in a && "g"in a && "b"in a ? (b = c.rgb2hsl(a), a.h = b.h, a.s = b.s, a.l = b.l, b = c.rgb2hsb(a), a.v = b.b) : (a = {hex: "none"}, a.r = a.g = a.b = a.h = a.s = a.v = a.l = -1)), a.toString = wa, a
    ...
    var Aa = c.pathBBox = function (a) {
        ...
        for (var d = Da(a), e = b && Da(b), f = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, g = {
            x: 0,
            y: 0,
            bx: 0,
            by: 0,
    ...
    }, null, Ba), Ka = (c._parseDots = f(function (a) {
    ...
    for (var Pa = function () {
        ...
        return A.doc.addEventListener ? function (a, b, c, d) {
            ...
            if (a.addEventListener(b, e, !1), F && L[b]) {
                var f = function (b) {
                    for (var e = Ta(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length; h > g; g++)if (b.targetTouches[g].target == a) {
    ...
    Ya.drag = function (a, d, e, f, g, h) {
        ...
        return this._drag = {}, $a.push({el: this, start: i}), this.mousedown(i), this
    ...
    v.getElementByPoint = function (a, b) {
        ...
        var b = {
            ...
            offsety: a.offsety || 0,
            color: a.color || "#000"
        }, c = b.width / 2, d = this.paper, e = d.set(), f = this.realPath || pa[this.type](this);
    ...
    var gb = [], hb = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame || function (a) {
            setTimeout(a, 16)
        }, ib = function () {
        for (var a = +new Date, d = 0; d < gb.length; d++) {
            ...
            if (!e.el.removed && !e.paused) {
                ...
                if (e.initstatus ? (h = (e.initstatus * e.anim.top - e.prev) / (e.percent - e.prev) * i, e.status = e.initstatus, delete e.initstatus, e.stop && gb.splice(d--, 1)) : e.status = (e.prev + (e.percent - e.prev) * (h / i)) / e.anim.top, !(0 > h))if (i > h) {
                    var q = j(h / i);
    ...
    Ya.animateWith = function (a, b, d, e, f, g) {
        ...
        for (var j = 0, k = gb.length; k > j; j++)if (gb[j].anim == b && gb[j].el == a) {
        ...
        for (c = gb.length; c > f; f++)if (d = gb[f], d.el.id == this.id && (!a || d.anim == a)) {
        ...
        for (var c = 0; c < gb.length; c++)if (gb[c].el.id == this.id && (!a || gb[c].anim == a)) {
            var d = gb[c];
    ...
    var kb = function (a) {
        if (this.items = [], this.length = 0, this.type = "set", a)for (var b = 0, c = a.length; c > b; b++)!a[b] || a[b].constructor != Ya.constructor && a[b].constructor != kb || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
    }, lb = kb.prototype;
    lb.push = function () {
