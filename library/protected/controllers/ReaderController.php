...
//				'actions'=>array('index','view', 'viewBooks'),
//				'users'=>array('*'),
//			),
...
//	}
	...
	public function actionReadersLoans($id)
	{
		$model=Reader::model()->findByPk($id);

		$this->render('readersLoans',array(
			'model'=>$model,
		));
	}
	/**
	...
	public function actionTopReaders (){
		$model = new Reader ('topReaders');
//		if(isset($_GET['Loan']))
//			$model->attributes=$_GET['Loan'];
		return $this->render('topReaders', array(
			'model' => $model,
		));
	}
